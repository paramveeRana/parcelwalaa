...
class _$CategoryItemImpl implements _CategoryItem {
  ...
  @override
  String toString() {
    return 'CategoryItem(id: $id, title: $title, subtitle: $subtitle, iconPath: $iconPath, isEnabled: $isEnabled)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, subtitle, iconPath, isEnabled);
